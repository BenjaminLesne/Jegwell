    ...
    ?>
        <section class="">
            ...
            if (count($product['cross_sells']) > 0) {
                $product_link = $_ENV['HOME_PAGE'] . '/creations/' . $product['slug'];
                    ...
                    <ul class="cross-sells__products products">
                        <li class="cross-sells__product-wrapper">
                            <article class="product cross-sells__product">
                                <a class="product__image-wrapper" href="<?php echo $_ENV['HOME_PAGE'] . '/creations/' . $product['slug'] ?>" data-options="1">
                                    <img class="product__image" src="https://cdn.sanity.io/images/b5g50abm/production/f2d6e8b4135ffcc7c2423d571d2d592f8c2137df-400x400.webp" alt="Meziere Bleu">
                                </a>
                                <div class="product__information">
                                    <a class="product__name" href="<?php echo $_ENV['HOME_PAGE'] ?>/creations/meziere-bleu">
                                        <span>Meziere Bleu</span>
                                    </a>
                                    <span class="product__price">35 €</span>
                                    <button class="product__call-to-action-wrapper" data-product-id="47bac148-2be5-434c-98d6-324a50bdfac0" data-product-option="default">
