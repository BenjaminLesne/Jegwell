...
// =========================================================================================================================================================================================
// $query = "
// *[_type == 'order' && _id == 'h9OYcuFnQXRN4hoEBtnH8T']{    
//     price,
//     'productsToBasket': productsToBasket[]{
//         quantity,
//         option,
...
// echo $email_bodies['html'];
// // echo $email_bodies['plain_text'];


// // send email to customer and forward to jegwell
// $was_email_sent = sendEmail('ben35170@hotmail.fr', 'Confirmation de votre commande', $email_bodies['html'], $email_bodies['plain_text']);
